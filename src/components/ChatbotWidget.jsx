    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-2xl shadow-2xl shadow-emerald-700/40 hover:scale-110 active:scale-95 transition-all flex items-center justify-center cursor-pointer focus:outline-none focus:ring-4 focus:ring-emerald-400 group"
        >
          <img 
        ...
        <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 w-[92vw] sm:w-[400px] h-[550px] max-h-[85vh] bg-white dark:bg-slate-900 border border-emerald-200 dark:border-slate-800 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-slide-up">
          ...
          <div className="p-4 bg-gradient-to-r from-emerald-600 to-green-600 text-white flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 rounded-xl overflow-hidden shrink-0 flex items-center justify-center filter drop-shadow-xs">
                <img 
                  src="/chatbot-avatar.png" 
                  alt="FarmBot AI" 
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3.5 text-xs">
            {messages.map((m) => (
              ...
              >
                {m.sender === 'bot' && (
                  <div className="w-8 h-8 rounded-xl overflow-hidden shrink-0 flex items-center justify-center filter drop-shadow-xs">
                    <img
                      src="/chatbot-avatar.png"
                      alt="FarmBot AI"
                      className="w-full h-full object-contain"
