/**
 * BudgetBasics - AI Financial Learning Assistant (BeeBot)
...
async function initBeeBot() {
  ...
  if (faqData) {
    ...
    if (faqData.disclaimer) {
      addDisclaimer(faqData.disclaimer);
    }
  ...
  function respond(query) {
    if (!faqData) {
      addBotMessage("I am currently updating my knowledge base. Please check back soon!");
      return;
    }
